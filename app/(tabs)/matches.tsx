...
// Mock: profilimi görüntüleyenler (ilk 6 kullanıcı)
const VIEWERS = MOCK_USERS.slice(0, 6);
// Mock: beni beğenenler (3-9. kullanıcılar)
        ...
        <Animated.View entering={FadeInDown.delay(60).duration(380)}>
          ...
          >
            {VIEWERS.map((u, i) => (
              ...
              >
                <View style={[styles.viewerRing, { borderColor: c.primary }]}>
                  <Image source={{ uri: u.photo }} style={styles.viewerAvatar} />
                  {u.online && (
        ...
        <Animated.View entering={FadeInDown.delay(140).duration(380)}>
          ...
          <View style={styles.cardsGrid}>
            {LIKED_ME.map((u, i) => (
              ...
              >
                <Image source={{ uri: u.photo }} style={styles.cardPhoto} />
                <LinearGradient
